...
<style lang="scss">
    ...
    :global(.proton-link-button) {
        color: white;
        cursor: pointer;
        text-align: center;
    }

    :global(.proton-link-subtitle) {
        font-size: 16px;
        line-height: 24px;
        display: block;
        margin-top: 10px;
    ...
    :global(.proton-link--anchor .proton-link-countdown) {
        color: #3650a2;
    }

    :global(.proton-link--proton) {
        .proton-link-inner {
            background: #752eeb;
            color: white;
        }
    ...
    :global(.proton-link--proton .proton-link-countdown) {
        color: #752eeb;
    }

    :global(.proton-link--webauth) {
        .proton-link-inner {
            background: #752eeb;
            color: white;
        }
    ...
    :global(.proton-link--webauth .proton-link-countdown) {
        color: #752eeb;
    }
